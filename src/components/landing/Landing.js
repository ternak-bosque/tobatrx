            ...
            <div className="max-w-3xl mx-8 md:mx-auto">
                <div className="my-20 space-y-10 text-center sm:my-16 md:space-y-14">
                    <div className="space-y-5 md:space-y-8">
                        <h1 className="text-3xl font-bold sm:text-5xl md:text-6xl text-gray-800 font-titles">
                            Token-Bound Accounts on Tron Network
                        </h1>
                        <h2 className="text-lg md:text-2xl md:mx-10 text-gray-600">
                            Discover new way to interact with NFTs and expand
                            its capabilities beyond simple static collectibles,
                    ...
                    <div className="transition duration-500 ease-in-out transform scale-100 translate-x-0 translate-y-0 opacity-100">
                        <div className="space-y-2">
                            <Link href="/wallet">
                                <span className="px-5 py-2 font-semibold text-gray-200 duration-500 ease-in-out shadow-lg hover:-translate-y-1.5 rounded-2xl md:text-xl md:px-8 md:py-3 bg-gradient-to-br to-purple-600 from-blue-500 hover:bg-gradient-to-br hover:to-blue-500 hover:from-purple-600">
            ...
            <div className="mt-20 space-y-6 text-center mb-28 md:mt-32">
                ...
                <div className="w-3/5 p-6 mx-auto bg-gray-100 rounded-2xl bg-opacity-70 md:bg-opacity-100 md:p-10">
                    <div className="flex flex-wrap items-center justify-center flex-shrink -mt-6 -ml-6 space-x-6 space-y-6">
                        <img
                            className="h-12 mt-6 ml-6 md:h-16"
